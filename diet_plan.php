...
4. Includes foods available locally in {$place} and {$preferences} if applicable
...
$result = json_decode($response, true);
$generated_plan = $result['candidates'][0]['content']['parts'][0]['text'] ?? 'Could not generate plan at this time.';
